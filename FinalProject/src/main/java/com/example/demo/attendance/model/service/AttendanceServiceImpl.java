...
public class AttendanceServiceImpl implements AttendanceService {
	...
	// 출퇴근 목록 조회 서비스
	public List<Attendance> getWeeklyAttendance(String empNo) {
		LocalDate today = LocalDate.now();
		
		// 이번 주 월요일 날짜 계산
		LocalDate monday = today.with(java.time.DayOfWeek.MONDAY);
		
		return attendanceRepository.findByEmpNoAndWorkDateBetweenOrderByWorkDateDesc(empNo, monday, today);
	}
